...
//         toast("You’ve reached your free download limit. Redirecting to Premium...");
//         setTimeout(() => {
//           router.push("/premium");
//         }, 2000);
//       }
...
//         <p className="text-gray-600">Videos you added to download will appear here</p>
//         {!user?.premium && (
//           <div className="mt-6 p-4 bg-yellow-100 border border-yellow-300 rounded text-center cursor-pointer"
...
//     <div className="space-y-4">
//       {!user?.premium && (
//         <div className="p-4 bg-yellow-100 border border-yellow-300 rounded text-center cursor-pointer"
//           onClick={() => router.push("/premium")}>
//           Upgrade to Premium for unlimited downloads
//         </div>
//       )}
...
//               <Button onClick={() => handleDownloadVideo(item.video!._id)} size="sm">

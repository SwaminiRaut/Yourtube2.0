...
const ChannelDialogue = ({ isopen, onclose, channeldata, mode }: any) => {
    ...
    //     image: "https://github.com/shadcn.png?height-34&width-32",
    // };
    ...
    return (
        <Dialog open={isopen} onOpenChange={onclose}>
            <DialogContent className="sm:max-w-md md:max-w-lg bg-white text-black dark:bg-gray-900 dark:text-white transition-colors duration-300">
                <DialogHeader>
                    <DialogTitle>
